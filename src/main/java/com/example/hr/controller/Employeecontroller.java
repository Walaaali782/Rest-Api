...
import com.example.hr.repository.Employteerepository;
...
public class Employeecontroller {
	...
	private Employteerepository employeerepo ;
...
Logger log = LoggerFactory.getLogger(Employeecontroller.class);
	...
	@Autowired
	public Employeecontroller(Employteerepository employeerepo) {
		super();
